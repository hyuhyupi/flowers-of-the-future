...
class ResponsiveBlob {
 ...
 // Remove the container based on screen size
 function removeContainer() {
  if (window.innerWidth < 1000) { // Change the screen width condition as needed
    document.body.removeChild(container);
  }
}

// Listen for window resize events
window.addEventListener('resize', removeContainer);
