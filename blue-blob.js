class ResponsiveBlob {
  ...
  var container = document.getElementById("blob-container-blue");
...
var newWidth = 500; // Set the new width
var newHeight = 500; // Set the new height
...
canvasElements.forEach(function(canvas) {
  ...
  var blobConfigurations = [
    {color: "blue", margin: 0, numPoints: 30, x: -10, y: 90, scale: 0.65},
  ]
